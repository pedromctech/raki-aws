    ...
    private setArgoCDHelmChart = (ns: k8s.core.v1.Namespace): k8s.helm.v3.Chart =>
        new k8s.helm.v3.Chart(
            'argocd',
            {
                ...
                values: FileUtils.yamlFileToObject('./lib/2-environments/argocd-values.yaml')
            },
